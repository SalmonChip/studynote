...
import com.studynote.notes.model.dto.note.CreateNoteRequest;
import com.studynote.notes.model.dto.note.NoteQueryParams;
import com.studynote.notes.model.dto.note.UpdateNoteRequest;
...
import com.studynote.notes.model.vo.category.CategoryVO;
import com.studynote.notes.model.vo.note.*;
import com.studynote.notes.scope.RequestScopeData;
import com.studynote.notes.service.*;
import com.studynote.notes.utils.ApiResponseUtil;
import com.studynote.notes.utils.MarkdownUtil;
import com.studynote.notes.utils.PaginationUtils;
import com.studynote.notes.utils.SearchUtils;
...
public class NoteServiceImpl implements NoteService {
    ...
    public ApiResponse<EmptyVO> updateNote(Integer noteId, UpdateNoteRequest request) {
        ...
        try {
            ...
            note.setSearchVector(SearchUtils.tokenizeContent(request.getContent()));
            ...
            for (CategoryVO.ChildrenCategoryVO childrenCategoryVO : categoryVO.getChildren()) {
                ...
                for (Question question : categoryQuestionList) {
                    ...
                    markdownContent.append("### [")
                            ...
                            .append("]")
                            .append("(https://notes.studynote.com/questions/")
